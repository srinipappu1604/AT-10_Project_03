...
class Test_TCPIM08:
    ...
    def test_tcpim08(self,booting_function):
        try:
            ...
            self.driver.find_element(by=By.XPATH, value =data.Orange_Selectors.dependents_button).click()
            time.sleep(5)
            
            self.driver.find_element(by=By.XPATH, value =data.Orange_Selectors.add_dependents).click()
            time.sleep(5)
            
            self.driver.find_element(by=By.XPATH, value =data.Orange_Selectors.name_dependents).send_keys(data.Dependents_details.name)
            time.sleep(5)
            
            relationship_child = self.driver.find_element(by=By.XPATH, value =data.Orange_Selectors.relationship_dependents)
            action = ActionChains(self.driver)
            action.click(on_element=relationship_child).perform()
            time.sleep(5)
            self.driver.find_element(by=By.XPATH, value =data.Orange_Selectors.relationship_dependents)
            time.sleep(3)
            
            self.driver.find_element(by=By.XPATH, value =data.Orange_Selectors.dateofbirth_dependents).send_keys(data.Dependents_details.dateofbirth)
            time.sleep(5)
            
            self.driver.find_element(by=By.XPATH, value =data.Orange_Selectors.save_dependents).click()
            time.sleep(5)
            print("SUCCESS # Updated Dependency Details")
            ...
            print("ERROR IN THE FUCTION - test_tcpim08")
