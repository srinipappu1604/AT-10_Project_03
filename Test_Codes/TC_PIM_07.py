...
class Test_TCPIM07:
    ...
    def test_tcpim07(self,booting_function):
        try:
            ...
            self.driver.find_element(by=By.XPATH, value =data.Orange_Selectors.add_emergency_button).click()
            time.sleep(5)
            
            self.driver.find_element(by=By.XPATH, value =data.Orange_Selectors.name_emergency).send_keys(data.emergency_contact.name)
            time.sleep(5)
            
            self.driver.find_element(by=By.XPATH, value =data.Orange_Selectors.relationship_emergency).send_keys(data.emergency_contact.relationship)
            time.sleep(5)
            
            self.driver.find_element(by=By.XPATH, value =data.Orange_Selectors.Hometelephone_emergency).send_keys(data.emergency_contact.Hometelephone)
            time.sleep(5)
            
            self.driver.find_element(by=By.XPATH, value =data.Orange_Selectors.mobile_emergency).send_keys(data.emergency_contact.mobile)
            time.sleep(5)
            
            self.driver.find_element(by=By.XPATH, value =data.Orange_Selectors.worktelephone_emergency).send_keys(data.emergency_contact.worktelephone)
            time.sleep(5)
            
            self.driver.find_element(by=By.XPATH, value =data.Orange_Selectors.save_emergency).click()
            time.sleep(5)
            print("SUCCESS # Updated Employee Emergency Contact Details")
            ...
            print("ERROR IN THE FUCTION - test_tcpim07")
